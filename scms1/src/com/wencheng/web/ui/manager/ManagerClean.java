...
public class ManagerClean extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<String> grades = ps.getGrades();
		List<Map<String, String>> map = ps.getGradesMap();
		request.setAttribute("map", map);
		request.setAttribute("grades", grades);
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/manager/clean.jsp").forward(request, response);
	}
