...
public class ManagerApplicationPage extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ManagerApplicationPage() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/views/upper/manager/otherapplication.jsp").forward(request, response);
	}
