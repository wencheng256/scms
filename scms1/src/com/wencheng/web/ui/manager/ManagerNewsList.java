...
public class ManagerNewsList extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ManagerNewsList() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/manager/newslist.jsp").forward(request, response);
	}
