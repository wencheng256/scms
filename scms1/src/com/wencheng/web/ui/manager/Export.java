...
public class Export extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ObjectDao<Export> obj = new ObjectDaoImpl<Export>();
		List<Export> ex = obj.list("Export");
		request.setAttribute("export", ex);
		ProjectService ps = new ProjectServiceImpl();
		List<String> grades = ps.getGrades();
		request.setAttribute("grades", grades);
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/manager/export.jsp").forward(request, response);
	}
