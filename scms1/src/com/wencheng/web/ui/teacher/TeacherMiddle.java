...
public class TeacherMiddle extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public TeacherMiddle() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/teacher/othermiddle.jsp").forward(request, response);
