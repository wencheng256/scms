...
public class EditPersonInfo extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(error!= null){
			request.setAttribute("message", URLDecoder.decode(error,"utf-8"));
		}
		
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/teacher/editinfo.jsp").forward(request, response);
	}
