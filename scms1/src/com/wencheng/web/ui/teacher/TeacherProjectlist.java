...
public class TeacherProjectlist extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public TeacherProjectlist() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Project> list = ps.listTeacher(request, start,rows);
		request.setAttribute("projects", list);
		request.setAttribute("nowpage", Integer.parseInt(page));
		request.setAttribute("pages", pagenum);
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/teacher/projectlist.jsp").forward(request, response);
	}
