...
public class TeacherProject extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Project project = ps.findOther(request);
		...
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/teacher/otherproject.jsp").forward(request, response);
	}
