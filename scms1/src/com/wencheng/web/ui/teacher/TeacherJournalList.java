...
public class TeacherJournalList extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public TeacherJournalList() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/teacher/otherjournallist.jsp").forward(request, response);
	}
