...
public class TeacherJournalPage extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/teacher/otherjournalpage.jsp").forward(request, response);
	}
