package com.wencheng.web.ui.statics;
...
public class StaticIndex extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/views/upper/manager/register.jsp").forward(request, response);
		return;
	}
