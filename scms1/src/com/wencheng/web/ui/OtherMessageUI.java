...
public class OtherMessageUI extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public OtherMessageUI() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//dispatcher
		request.getRequestDispatcher("/WEB-INF/views/upper/student/othermessage.jsp").forward(request, response);
	}
