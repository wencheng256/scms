...
public class Mkcap extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(ss.mkcaptain(request)){
			System.out.println("success");
			response.sendRedirect(request.getContextPath()+"/student/team");
			return;
		}else{
			response.sendRedirect(request.getContextPath()+"/student/team?errormessage="+URLEncoder.encode("晋升失败！","UTF-8"));
			return;
		}
	}
