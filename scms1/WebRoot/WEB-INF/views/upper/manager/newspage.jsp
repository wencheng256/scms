...
<body>
    ...
    <div class="fllist">
    	<h1 style="text-align:center;font-size:42px;line-height:45px;height:50px;">${news.title}</h1>
    	<div style="text-align:center;padding:5px;"><i>作者：${news.edit.name} 时间:${news.date}</i></div>
    	<div style="text-align:center;padding:5px;"><i>类型:
			<c:choose>
