...
<div class="theCenterBox" style="">
  <div class="theLoginBox">
    <div class="loginTxt">管理员登录</div>
    <div class="theLoginArea" id="loginBox">
      <form id="leftForm" action="${path }manageloginaction" method="post">
        ...
        <div class="loginSubmitBnt fixPadding">
          <div>
            ...
            <em class="forgotPasswordEm"><a href="#" title="忘记密码">忘记密码?</a>&nbsp;&nbsp;&nbsp;<a href="${path}/register" title="注册项目">注册管理员</a></em>
