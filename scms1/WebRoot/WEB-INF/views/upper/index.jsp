            ...
            <div class="dhwz">
                ...
                <div class="btright">
                    <a href="User/StudentInfor/Letter.aspx.html">
                        <img src="${path}images/Student/default/bt_bzr.jpg" alt="给班主任发消息" width="121" height="25" /></a></div>
            </div>
        </div>
        <div class="dh2">
            <div class="dhwz">
                ...
                <div class="btright">
                    <a href="EducationCenter/Application.aspx.html">
                        <img src="${path}images/Student/default/bt_jw.jpg" alt="进入教务中心" width="121" height="25" /></a></div>
            </div>
        </div>
            ...
            <div class="dhwz">
                ...
                <div class="btright">
                    <a href="http://sm.zk0731.com/User/ExamCenter/ExamPractice/ListExam.aspx?ptid=1">
                        <img src="${path}images/Student/default/bt_ks.jpg" alt="进入考试中心" width="121" height="25" /></a></div>
            </div>
        </div>
        <div class="dh4">
            <div class="dhwz">
                ...
                <div class="btright">
                    <a href="MyAccount/wdcw.aspx.html">
                        <img src="${path}images/Student/default/bt_cw.jpg" alt="进入财务中心" width="121" height="25" /></a></div>
            </div>
        </div>
    </div>
