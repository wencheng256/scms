...
<div class="cztable">
	<form action="${path }student/endaction" method="post">
	
	<input type="hidden" name="version"  value="${version}" />
	<c:if test="${endid != null}">
    	<input type="hidden" name="id" id="tValue" value="${endid}" />
   	</c:if>
    <table border="0" cellspacing="0" cellpadding="0" width="100%" >
        ...
        <tr>
            ...
            <td colspan="5"><textarea name="status" id="status" cols="100" rows="5">${end.status}</textarea></td>
        </tr>
        <tr>
            <td width="91" align="right">研究成果</td>
            <td colspan="5"><textarea name="result" id="result" cols="100" rows="5">${end.result}</textarea></td>
        </tr>
        <tr>
            <td width="91" align="right">感想体会</td>
            <td colspan="5"><textarea name="thought" id="thought" cols="100" rows="5">${end.thought}</textarea></td>
        </tr>
        <tr>
            <td width="91" align="right">经费使用情况</td>
            <td colspan="5"><textarea name="feeused" id="feeused" cols="100" rows="5">${end.feeused}</textarea></td>
        </tr>
        <tr>
